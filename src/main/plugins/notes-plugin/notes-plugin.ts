...
import { defaultNotesIcon } from "../../../common/icon/default-icons";
        ...
        return new Promise((resolve) => {
            if(userInput.startsWith(this.config.prefixWrite)) {
                ...
                const result: SearchResultItem = {
                    description: this.translationSet.notesWriteDescription,
                    executionArgument: "add:" + note,
                    hideMainWindowAfterExecution: true,
                    icon: defaultNotesIcon,
                    name: this.translationSet.notesNew + note,
                ...
                notes.forEach(note => {
                    results.push({
                        description: this.translationSet.notesReadDescription,
