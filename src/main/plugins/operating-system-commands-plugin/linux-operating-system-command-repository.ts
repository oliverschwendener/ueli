...
export class LinuxOperatingSystemCommandRepository implements OperatingSystemCommandRepository {
    ...
    private getOperatingSystemCommands(): OperatingSystemCommand[] {
        ...
        return [
            {
                description: this.translationSet.linuxShutdownDescription,
                executionArgument: `poweroff`,
                icon: {
                ...
                name: this.translationSet.linuxShutdown,
                searchable: [this.translationSet.linuxShutdown],
            },
            {
                description: this.translationSet.linuxRestartDescription,
                executionArgument: `reboot`,
                icon: {
                ...
                name: this.translationSet.linuxRestart,
                searchable: [this.translationSet.linuxRestart],
            },
            {
                description: this.translationSet.linuxLogoutDescription,
                executionArgument: systemCommandMapping[version]["logout"],
                icon: {
                ...
                name: this.translationSet.linuxLogout,
                searchable: [this.translationSet.linuxLogout],
            },
            {
                description: this.translationSet.linuxSleepDescription,
                executionArgument: `systemctl suspend`,
                icon: {
                ...
                name: this.translationSet.linuxSleep,
                searchable: [this.translationSet.linuxSleep],
            },
            {
                description: this.translationSet.linuxLockDescription,
                executionArgument: systemCommandMapping[version]["lockscreen"],
                icon: {
                ...
                name: this.translationSet.linuxLock,
                searchable: [this.translationSet.linuxLock],
            },
        ];
    }
}
