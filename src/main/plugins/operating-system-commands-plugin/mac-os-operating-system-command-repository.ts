...
export class MacOsOperatingSystemCommandRepository implements OperatingSystemCommandRepository {
    ...
    private getOperatingSystemCommands(translationSet: TranslationSet): OperatingSystemCommand[] {
        return [
            {
                description: translationSet.macOsShutdownDescription,
                ...
                name: translationSet.macOsShutdown,
                searchable: [translationSet.macOsShutdown],
            },
            {
                description: translationSet.macOsRestartDescription,
                executionArgument: `/System/Library/CoreServices/Menu\\ Extras/User.menu/Contents/Resources/CGSession -suspend`,
                icon: {
                ...
                name: translationSet.macOsRestart,
                searchable: [translationSet.macOsRestart],
            },
            {
                description: translationSet.macOsLogoutDescription,
                executionArgument: `/System/Library/CoreServices/Menu\\ Extras/User.menu/Contents/Resources/CGSession -suspend`,
                icon: {
                ...
                name: translationSet.macOsLogout,
                searchable: [translationSet.macOsLogout],
            },
            {
                description: translationSet.macOsLockDescription,
                executionArgument: `/System/Library/CoreServices/Menu\\ Extras/User.menu/Contents/Resources/CGSession -suspend`,
                icon: {
                ...
                name: translationSet.macOsLock,
                searchable: [translationSet.macOsLock],
            },
        ];
    }
}
