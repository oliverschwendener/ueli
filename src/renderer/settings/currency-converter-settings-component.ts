        ...
        <div class="settings__setting-content">
            ...
            <div class="box">
                <div class="settings__option-container">
                    ...
                    <div class="settings__option">
                        <div class="settings__option-name">{{ translations.currencyConverterSeparator }}</div>
                        <div class="settings__option-content">
                            <div class="field is-grouped is-grouped-right">
                                <div class="control">
                                    <input class="input font-mono" v-model="config.currencyConverterOptions.separator" @change="updateConfig">
                                </div>
                            </div>
                        </div>
                    </div>
