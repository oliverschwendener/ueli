...
import { newBookmarksFileModalComponent } from "./settings/modals/new-bookmarks-file-modal-component";
...
Vue.component("new-bookmarks-file-modal", newBookmarksFileModalComponent);
