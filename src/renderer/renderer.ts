...
import { processKillerSettingsComponent } from "./settings/process-killer-settings-component";
...
Vue.component("process-killer-settings", processKillerSettingsComponent);
