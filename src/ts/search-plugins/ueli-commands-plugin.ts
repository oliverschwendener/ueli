...
export class UeliCommandsSearchPlugin implements SearchPlugin {
    private readonly icon = `<svg version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 600 600" xml:space="preserve">
    ...
    private readonly ueliCommands: UeliCommand[] = [
        {
