export const shutDownIcon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
...
export const restartIcon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const logOutIcon = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 26 26" version="1.1">
                                <g id="surface1">
...
export const lockIcon = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" version="1.1">
                                <g id="surface1">
