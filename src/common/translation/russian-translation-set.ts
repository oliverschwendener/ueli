...
export const russianTranslationSet: TranslationSet = {
    ...
    appearanceSettingsScrollbarBorderRadius: "Радиус заругления полосы прокрутки",
    ...
    appearanceSettingsSearchResultDescriptionFontWeight: "Вес шрифта описания резальтата поиска",
    ...
    appearanceSettingsSearchResultNameFontSize: "Размер шрифта описания резальтата поиска",
    ...
    translationSettingsDescription: `Этот плагин позволяет быстро переводить слова или короткие предложения. Исползуется неофициальный API перевод (https://github.com/imankulov/linguee-api) для Linguee (https://linguee.de), функция может быть не стабильна.`,
