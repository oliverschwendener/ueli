...
export const russianTranslationSet: TranslationSet = {
    ...
    hotkeyKeySpace: "Пробел",
    hotkeyKeyTab: "Tab",
    hotkeyKeyUp: "Стелка вверх",
    ...
    everythingSearchSettingDescription: `Этот плагин позволяет использовать Everything для поиска файлов и папок на вашем компьютере. Для этого вы должны установить 'Everything' и 'интерфейс Everything для командной строки' по адресу https://www.voidtools.com/ru-ru/downloads/. После установки, необходимо указать путь до файла 'es.exe' ниже.`,
