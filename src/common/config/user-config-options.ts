...
import { ProcessKillerOptions, defaultProcessKillerOptions } from "./process-killer-options";
...
export interface UserConfigOptions {
    ...
    processKillerOptions: ProcessKillerOptions;
}
...
export const defaultUserConfigOptions: UserConfigOptions = {
    ...
    processKillerOptions: defaultProcessKillerOptions,
};
